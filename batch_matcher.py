...
def process_batches(loader, matcher='lightglue', output_path=None):
    '''
    Run image matching in batch
    Args:
        loader (DataLoader): dataloader containing pair of images and their descriptor data
        matcher (str): matcher type (flann / lightglue)
        output_path (str): path to save the batch output
    '''
    all_matches = []
