...
#                matcher = LightGlue(features=descriptor.lower()).eval().to(device)
            ...
            for i in range(len(batch['image0_name'])):
                with torch.inference_mode():
                    ...
                    points0, points1, matches = match_features_for_plots(feats0_device,feats1_device,descriptor='disk', device= device)
            ...
            out_path = os.path.join(output_path, f"{batch_idx}_lightglue_disk.h5")
